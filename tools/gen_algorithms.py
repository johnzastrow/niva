...
repo root:
    ...
    PYTHONPATH=$PWD:/usr/lib/python3/dist-packages:/usr/share/qgis/python \
        QT_QPA_PLATFORM=offscreen python3.14 tools/gen_algorithms.py
...
def main():
    ...
    for provider in sorted(by_provider):
        ...
        lines = [
            ...
            f"(QGIS {QGIS_VERSION}). Auto-generated by `tools/gen_algorithms.py`; "
    ...
    idx = [
        ...
        "",
        "This is auto-generated — regenerate with `tools/gen_algorithms.py` after a QGIS "
