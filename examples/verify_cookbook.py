...
RECIPES = [
    ...
    ("clip→fix→dissolve", "B", f'load "{V}|layername=parcels" | clip "{V}|layername=aoi" | fixgeom | dissolve zoning | save "{{OUT}}/o.gpkg"'),
    ...
    ("difference", "D", f'load "{V}|layername=parcels" | fixgeom | difference "{V}|layername=buildings" | save "{{OUT}}/o.gpkg"'),
