...
class TestExport(unittest.TestCase):
    ...
    def test_export_threads_input_output_and_save(self):
        py = export_script('load "a.gpkg" | buffer 100m | run native:centroids '
    ...
    def test_multiple_flows_get_distinct_vars_and_keep_explicit_output(self):
        ...
        flow = ('run gdal:buildvirtualraster INPUT="t/*.tif" OUTPUT=/tmp/m.vrt SEPARATE=False\n'
    ...
    def test_export_run_escape_hatch_is_verbatim(self):
        py = export_script('run gdal:translate INPUT=in.vrt OUTPUT=out.jp2 '
                           'OPTIONS="QUALITY=25"')
...
class TestImport(unittest.TestCase):
    ...
    def test_round_trip_export_then_import(self):
        original = ('load "a.gpkg" | run native:buffer DISTANCE=5 | '
    ...
    def test_edit_exported_py_then_import_picks_up_new_params(self):
        ...
        py = export_script('load "a.gpkg" | run native:buffer DISTANCE=5 | save "out.gpkg"')
        ...
        edited = (py.replace("'DISTANCE': 5", "'DISTANCE': 12, 'SEGMENTS': 24, 'JOIN_STYLE': 1"))
    ...
    def test_add_whole_new_processing_step_then_import(self):
        ...
        py = export_script('load "a.gpkg" | run native:buffer DISTANCE=5 | save "out.gpkg"')
        new_step = ("    step9 = processing.run('native:dissolve', "
